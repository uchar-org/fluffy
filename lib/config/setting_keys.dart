...
enum AppSettings<T> {
  ...
  website<String>('chat.fluffy.website_url', 'https://uchar.uz'),
  logoUrl<String>(
    'chat.fluffy.logo_url',
    'https://uchar.uz/assets/favicon.png',
  ),
  privacyPolicy<String>(
    'chat.fluffy.privacy_policy_url',
    'https://uchar.uz/en/privacy',
  ),
  tos<String>('chat.fluffy.tos_url', 'https://uchar.uz/en/tos'),
